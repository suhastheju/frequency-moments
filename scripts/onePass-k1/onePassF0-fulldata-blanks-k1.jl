...
label_onePassF0 = "One Pass F0 with blanklines"

k = 1 # iterations
i = 911740903

results_onePassF0 = @eval @measureCall(
    onePassF0("data/twitter_words.txt"),
    0, # baseline_results_F0[$i],
    $i, $k, $label_onePassF0)

writetable("results/results_onePassF0-fulldata-blanks-k1.csv", results_onePassF0)
